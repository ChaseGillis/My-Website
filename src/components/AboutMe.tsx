  ...
  return (
    <div id="about" className="about-container">
      ...
      <div className="about-text">
        ...
        <br/><br/>
        I combine my expertise in Python, SQL, Java, and JavaScript with the work ethic and resilience I cultivated through being a student-athlete and state champion wrestler to tackle real-world problems and create impactful solutions. All of my previous roles, from SWE Consulting to leading a project dedicated to aiding legal research, involved optimizing systems or improving processes, aligning with my ultimate goal of using technology to make an impact.
        <br/><br/>
